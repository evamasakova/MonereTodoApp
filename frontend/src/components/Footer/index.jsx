    ...
    <div className="w-full flex justify-center">
      <footer className="w-full px-4 py-1 sm:w-full md:w-1/2 lg:w-1/3 bg-white rounded-xl shadow-2xl/40">
        <div className="relative flex justify-center items-end">
          ...
          {/* Plus Button */}
          <Link to="/create-task">
            <button className="font-bold absolute -top-9.5 left-1/2 -translate-x-1/2 bg-indigo-900 shadow-lg/90 text-white rounded-full w-16 h-16 flex items-center justify-center shadow-xl text-3xl hover:bg-purple-700 transition">
              +
            </button>
          </Link>
